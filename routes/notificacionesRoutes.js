...
module.exports = (app) => {
    ...
    app.get('/api/notificacion/findByType/:type', NotificationesController.findByType);
    app.put('/api/notificacion/update', NotificationesController.update);
    app.put('/api/notificacion/read/:idNotification', NotificationesController.readNotification);
